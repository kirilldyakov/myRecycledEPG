...
public class ScheduleDAO extends BaseDaoImpl<ScheduleDB, Integer> {
    ...
    public List<ChannelDB> getActiveChanennelsOffset(long currentDT, long offset)
            throws SQLException {
        ...
        for (int i = 0; i < activeChIds.size(); i++) {
            ...
            activeChannels.add(HelperFactory.getHelper()
                    .getChannelDAO().getChanelDBByEpg_Id(activeChIds.get(i)));
        }
    ...
    public List<ScheduleDB> getActiveSchedules(int epg_channel_id, long currentDT, long offset)
            throws SQLException {
        ...
        for (int i = 0; i < activeSchdlIds.size(); i++) {
            ...
            activeSchedules.add(HelperFactory.getHelper()
                    .getScheduleDAO().getScheduleDBByEpg_Id(activeSchdlIds.get(i)));
    ...
    public void createScheduleDB(Schedule schdl) throws SQLException {
